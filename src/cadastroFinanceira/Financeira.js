...
export default class Financeira extends Component {
    constructor(props) {
        super(props);
    ...
    enviar() {
        if (this.state.id) {
            ...
            this.props.onAdicionarFinanceira({
                nome: this.state.nome,
                endereco: this.state.endereco,
                cnpj: this.state.cnpj,
                telefone: this.state.telefone,
    ...
    render() {
        ...
        >
            <DialogTitle>{this.state.id ?
                <h3> Editar Financeira {this.state.nome} de Id: {this.state.id} </h3> :
                <h3>Cadastrar Financeira</h3>}</DialogTitle>
            <DialogContent>
                <TextField
                    autoFocus
                    margin="dense"
